...
const dinoDatabase = {
    ...
    "Ornithomimus": {
        ...
        passives: [
            ...
            { title: "Corredor de maratona", desc: "Quando há membros da matilha perto de você, sua recuperação de vigor acelera (até 2 vezes: +15% regeneração de vigor).", icon: "img/skill/rebanhoH.png" },
    ...
    "Quetzalcoatlus": {
        ...
        diet: "🥩🦈",
        stats: { group: "3 slots", growth: "41 min", price: "125.000", skin1: "-", skin2: "-", fotinha: "15.000", cormoeda: "4000", corgema: "40" },
        passives: [
        ...
        actives: [
            { title: "Capturar", desc: "Seu dinossauro agarra uma presa com o bico podendo levá-lo consigo, gastando vigor para tal. Funciona apenas com animais menores e reduz sua velocidade (-15% velocidade). Dano base: 160.", icon: "img/skill/capturar.png" }
        ]
    },
    "Austroraptor": {
        idStatus: "austro",
        ...
        actives: [
            { title: "Ataque do céu", desc: "Salta rapidamente, atacando o inimigo, há chances de reduzir sua defesa (-15% defesa inimiga). Dano base: 200.", icon: "img/skill/mordida.png" },
    ...
    "Concavenator": {
        ...
        passives: [
            { title: "O poder do bando", desc: "Quando os membros da matilha estão próximos, você recupera HP mais rápido (até 3 vezes: +20% recuperação de HP).", icon: "img/skill/rebanho.png" },
    ...
    "Carnotaurus": {
        ...
        diet: "🥩",
        stats: { group: "2.5 slots", growth: "29 min", price: "100.000", skin1: "-", skin2: "-", fotinha: "150g", cormoeda: "2500", corgema: "25" },
        passives: [
    ...
    "Gigantoraptor": {
        ...
        diet: "🥩🌿",
        stats: { group: "2 slots", growth: "42 min", price: "55.000", skin1: "-", skin2: "-", fotinha: "15.000", cormoeda: "3000", corgema: "30" },
        passives: [
