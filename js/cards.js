...
function getCardImage(image = "") {
    let castImagem = image.includes("perfil") ? image.replace("perfil", "Model") : image;
    castImagem = castImagem.includes("pict") ? castImagem.replace("pict", "noBackGround") : castImagem;
